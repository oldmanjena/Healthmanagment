...
namespace Healthmanagment.ViewModel
{
    public class WochenplanViewModel : INotifyPropertyChanged
    {
        ...
        public string AusgewaehlteMuskelgruppe
        {
            ...
            set
            {
                if (_ausgewaehlteMuskelgruppe != value)
                {
                    ...
                    OnPropertyChanged();
                    LadeWochenDaten(); // reload bei ?nderung
                }
            }
        }
        ...
        public void LadeWochenDaten()
        {
            ...
            List<Healthmanagment.Klassen.WochenEintrag> daten = new();
        ...
        public void ExportiereWochenplanAlsPdf()
        {
            ...
            // Tabelle in zentrierten Absatz einf?gen
            // Tabelle zentriert hinzuf?gen
