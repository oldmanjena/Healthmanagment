...
namespace Healthmanagment.ViewModel
{
    public class SchmerzAufViewModel : INotifyPropertyChanged
    {
        ...
        // Beispiel-Command f?r sp?ter (Speichern etc.)
        ...
        //Alles f?r das Insert in die Datenbank
        ...
        public int MediVorhanden
        {
            ...
            set
            {
                ...
                OnPropertyChanged(); // Informiert das ViewModel ?ber die ?nderung
            }
        }
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection("data source=DESKTOP-726MH0T;initial catalog=managment;trusted_connection=true"))
                {
                    ...
                    VALUES
                        ...
                        cmd.Parameters.AddWithValue("@detail", "leer"); // kannst du sp?ter noch dynamisch machen
